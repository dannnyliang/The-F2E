...
class Task extends React.Component {
  ...
  render () {
    const taskbottom = this.state.isEdit ? (
      ...
      <Taskinfo deadline={this.state.deadline} file={this.state.file} comment={this.state.comment} />
    )
    ...
    return (
      ...
      <div className="task-top">
        <FontAwesomeIcon size="2x" className="task-checkbox" 
        ...
        <FontAwesomeIcon icon={faStar} size="lg" className="task-star" 
          color={this.state.isStar ? '#F5A623' : 'black'} onClick={this.toggleStar.bind(this)} />
        <FontAwesomeIcon icon={faEdit} size="lg" className="task-pencil" 
            color={this.state.isEdit ? '#4A90E2' :'black'} onClick={this.toggleEdit.bind(this)} />
      </div>
